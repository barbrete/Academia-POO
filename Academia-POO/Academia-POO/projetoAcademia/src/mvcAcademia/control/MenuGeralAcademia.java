...
public class MenuGeralAcademia {
    ...
    private AvaliacaoFisica cadastraAvaliacaoFisica() {
        ...
        if (pessoa != null) {
            ...
            scanner.nextLine();
            double calcula = av.calculaIMC(peso, altura);//se tiver algum erro me perdoe estou coringando
            ...
            switch (resp) {
                ...
                case 5:
                    ...
                    if (pessoaParaAssociar != null) {
                        ...
                        PagamentoRecorrente pagamentoAssociar = pagamentoRecorrenteDAO.buscaPorId(idPagamentoAssociar);
